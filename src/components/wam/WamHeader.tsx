      ...
      >
        ...
        <div className="z-[60] flex items-center">
          <a href="/" className="flex items-center gap-6 group">
            <div className="w-14 h-14 relative flex items-center justify-center p-3 rounded-2xl bg-white/[0.03] border border-white/10 group-hover:border-primary/40 group-hover:bg-primary/5 transition-all duration-700">
              <img 
                src="/logo_pg.png" 
                alt="PG Logo" 
                className="w-full h-full object-contain filter group-hover:drop-shadow-neon transition-all" 
              />
